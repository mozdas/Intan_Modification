Intan Recording Controller Software - Pre-Compiled Windows Version
------------------------------------------------------------------

This directory contains the Intan Recording Controller executable file
(IntanRecordingController.exe) and four supporting files: main.bit (the FPGA configuration file),
...
the GUI, double-click on IntanRecordingController.exe. (Intan Technologies does not currently offer
...
Intan Technologies does not currently distribute Linux executables file for the Recording
